...
RUN_NAME="${RUN_NAME:-dfd-v3-dual-policy}"
SEED="${SEED:-0}"
CONFIG_PATH="${CONFIG_PATH:-${REPO_ROOT}/pwm_isaaclab_dfd_v3/config_dfd_v3.yaml}"
...
exec "${ISAACLAB_SH}" -p "${REPO_ROOT}/pwm_isaaclab_dfd_v3/train_dfd_v3.py" "${args[@]}" "$@"
